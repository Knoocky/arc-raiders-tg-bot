...
def test_formats_current_primary_line_with_chat_timezone() -> None:
    ...
    assert "<b>🟢 23:00 UTC+5 - Space Port - ещё 12 мин</b>" in text
...
def test_formats_nearest_future_primary_line_with_named_timezone() -> None:
    ...
    assert "<b>⏳ 19:47 CET - Blue Gate - через 47 мин</b>" in text
...
def test_truncates_too_long_message_safely() -> None:
    ...
    text = format_events_summary(groups, now=now, timezone_context=timezone_context, max_length=120)
